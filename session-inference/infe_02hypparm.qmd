...
An alternative approach is to use the Central limit theorem, see @thm-CLT, and use the normal approximation.
...
Alternatively, a one sided alternative hypothesis can be used; $H_1: \pi_1 - \pi_2 >0$ or $H_1: \pi_1 - \pi_2 < 0$. <!-- If $H_0$ is true -->
