...
$X$ is binomially distributed under the null hypothesis. There is no need to use resampling here, so we can use the binomial distribution to answer the question.
...
$P(X \geq 42) = `r format(1-pbinom(41,100,0.3), digits=4)`
