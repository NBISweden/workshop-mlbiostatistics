...
c) the probability of having cancer, if the test is poitive?
...
a) $P(pos|cancer) = 16/20$, PPV
b) $P(neg|not cancer) = 882/980$, NPV
c) $P(cancer|pos) = 16/114$, sensitivity
d) $P(not cancer|neg) = 882/886$, specificity
