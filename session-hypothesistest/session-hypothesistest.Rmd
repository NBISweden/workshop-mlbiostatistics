...
$$p = P(P>\pi_0) = P(Z>>_{obs}) = P(Z>`r format(zobs, digits=3)`) = [table]$$
...
1. Randomly assign 12 of the 24 mice to 'high-fat' and the remaining 12 to 'control' (ordinary diet).
