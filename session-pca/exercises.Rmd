...
Edgar Anderson's iris data will be used for exercises here.
The data is already available with R, which stored in `iris`.
...
```{r, results='markup', fig.dim=c(8, 8)}
https://static-content.springer.com/esm/art%3A10.1038%2Fs41467-021-23893-4/MediaObjects/41467_2021_23893_MOESM6_ESM.xlsx
