...
As $p > \alpha$, we fail to reject the null hypothesis. The data do not provide evidence that the Hb value in men differs from that of women (140 mg/L).
...
Compute the p-value:
$$p=P(\bar X \leq 188) = P(Z \leq zobs).$$
