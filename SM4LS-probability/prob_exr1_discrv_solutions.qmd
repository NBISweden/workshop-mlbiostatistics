...
d)  $P(X\text{ is even}) = P(X=0) + P(X=2) + P(X=4) + P(X=6) = 0.14 + 0.27 + 0.13 + 0.02 = 0.56$
:::
:::
...
a)  $P(X=6) = \frac{1}{6}$
b)  $P(X\text{ is even}) = \frac{3}{6} = \frac{1}{2}$
c)  $P(X \geq 3) = P(X=3) + P(X=4) + P(X=5) + P(X=6) = \frac{1}{6} + \frac{1}{6} + \frac{1}{6} + \frac{1}{6} = \frac{4}{6} = \frac{2}{3}$
...
e)  Which is the most likely number of antibiotic resistant colonies?
f)  What is the probability to get exactly 2 antibiotic resistant colonies?
g)  On average how many antibiotic resistant colonies would you get if the experiment is repeated many times?
