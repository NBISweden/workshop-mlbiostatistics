...
1. Take a minute to look at [today's questions](https://docs.google.com/forms/d/e/1FAIpQLSdy2hqyTqgc9STuo8Of1j9vDABQs2qw4QjVR0sHWJc0AUhQ9g/viewform?usp=sf_link) and rate your knowledge
...
a) probability mass function can be provided summarized in a table for a continuous random variable
b) probability density function can be provided summarized in a table for a continuous random variable
c) probability mass function can be provided summarized in table for a discrete random variable
