...
::: incremental
-   We need to check that the model provides an adequate description of the data, before using the model.
-   There are formal assumptions that should be met when fitting linear models.
:::
