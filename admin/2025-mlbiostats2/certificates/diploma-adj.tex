...
\newcommand{\courseName}{Machine Learning for Life Sciences}
%\newcommand{\coursePoints}{1 hp}
\newcommand{\courseLocation}{in Uppsala}
\newcommand{\courseDate}{7-13th June 2025}
\newcommand{\courseLastDay}{2025-06-13}
...
\begin{itemize}
\item Common data analysis steps (pass)
\item Dimensionality reduction beyond PCA (pass)
\item Bagging, boosting, and stacking (pass)
\item PLS methods for single and multi-omics data analysis (pass)
\item Mixed-effects models (pass)
\item Survival analysis (pass)
\item Causal inference (pass)
\item Introduction to neural networks (pass)
\end{itemize}
