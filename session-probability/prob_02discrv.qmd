...
```{r dice, fig.height=3, fig.width=7, fig.cap="Probability mass function of a fair dice.", out.width="45%", fig.align='center'}
...
The number of bacterial colony forming units (CFU) on a plate is a random number.
...
-   *less than 15 bacterial colonies on the agar plate* - sum upp the probabilities \$P(X\<15) = \sum\_{k=0}\^{14} p(k) = \$ `r ppois(14, 25)`.
