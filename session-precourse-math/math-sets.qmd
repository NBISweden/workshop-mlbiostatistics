...
ggvenn(venn.example_01)
# ggVennDiagram(venn.example_01,  color = "blue") + 
...
ggvenn(venn.example_02)
# ggVennDiagram(venn.example_02) + 
#   theme(legend.position="none") + 
#   scale_fill_gradient(low = "#F4FAFE", high = "#4981BF") + 
...
# ggVennDiagram(venn.example_03, label = "count") + 
#   theme(legend.position="none") + 
#   scale_fill_gradient(low = "#F4FAFE", high = "#4981BF") + 
#   scale_color_manual(values = c("grey", "grey"))
ggvenn(venn.example_03)
...
a) what is $T$, a subset of $S$ consisting of its even elements?
b) what is the complement $T^c$? 
c) what is $U$, the subset of $S$ containing of the prime numbers in $S$?
...
Given set $$A = \{domestic \;cat, elephant, dog, turtle, goldfish, hamster, parrot, tiger, guinea\; pig, lion\}$$ and its subset $D$ of domesticated animals $D = \{domestic \;cat, dog, turtle, goldfish, hamster, parrot, guinea \;pig\}$
  
a) what is $D^c$, the complement of $D$?
b) what is $C$, subset of $A$ consisting of Felidae (cat) family?
b) what is $I$, the intersection of $D$ and $C$?
d) what is $U$, the union of $D^c$ and $C$?
e) what is $Z$, the set difference of $A \setminus C$?
...
a <- c("domestic cat", "elephant", "dog", "turtle", "goldfish", "hamster", "parrot", "tiger", "guinea pig", "lion")
d <- c("domestic cat", "dog", "turtle", "goldfish", "hamster", "parrot", "guinea pig")
c <- c("domestic cat", "tiger", "lion")
dc <- setdiff(a, d)

```

a) $D^c = \{elephant, tiger, lion\}$
b) $C = \{domsetic \;cat, tiger, lion\}$
c) $I = \{domestic \;cat\}$
d) $U = \{domestic \;cat, elephant, tiger, lion\}$
e) $Z = \{elephant, dog, turtle, goldfish, hamster, parrot, guinea \;pig\}$
f) 
...
venn.example_04 <- list(D=d, C=c)
ggvenn(venn.example_04)
```
