...
The effect of high-fat diet on the body weight of mice is tudied in an experiment. The study setup is as follows:
...
# Exercises: Hypothesis tests, resampling {.unnumbered #infe-exercise1-hypresamp}
...
$P(X \geq 42) = 1 - P(X \leq 41)$ [`1-pbinom(41,100,0.3)`} = `r `1-pbinom(41,100,0.3)`
...
# Exercises: Hypothesis tests, parametric {.unnumbered #infe-exercise2-hypparam}
