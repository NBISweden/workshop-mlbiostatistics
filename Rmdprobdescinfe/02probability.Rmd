...
In a clinical trial patients are randomly assigned to treatment or control group, with probability 0.5 of being included in the treatment group.

When 20 patient have been recruited to the study;

  a) what is the probability of exactly 15 assigned to the treatment group?
  b) what is the probability of less than 7 assigned to the treatment group?
  c) What is the most probable number of patients in the treatment group?
  d) what is the probability of 5 or less in the control group?
  e) what is the probability of 2 or less in the treatment group?
```
