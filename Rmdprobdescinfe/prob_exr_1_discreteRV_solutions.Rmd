...
The number of children in a random household is a random variable, $X$.
...
The random variable, $X$, describe the number of dots on the upper face of a die.
...
The results differ. In \@ref(exr:Pollen) the probability of selecting an allergic person is constant, regardless of the status of previously selected persons. On the other hand in the situations in \@ref(exr:Pollen2) and \@ref(exr:Pollen3), the probability of selecting an allergic person changes depending on the persons selected before.
