...
bookdown::render_book(c("index.Rmd", "02probability.Rmd"), output_dir="../session-probability", preview=TRUE, bookdown::html_book(lib_dir = "libs", number_sections=TRUE, toc=FALSE, split_by="chapter"))
...
bookdown::render_book(c("index.Rmd", "03inference.Rmd"), output_dir="../session-inference", preview=TRUE, bookdown::html_book(lib_dir = "libs", toc=FALSE, number_sections=TRUE, split_by="chapter"))
##Clustering
