...
As WSS is constantly decreasing for increasing $k$, we can't use the minimum to find optimal $k$. Eyeballing as in the elbow method is one option, but another is to use gap 
