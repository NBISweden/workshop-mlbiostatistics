...
```{example, name="Left handedness", label="lefthandedness", echo=TRUE}
...
d) [Save this question to the probability session] If the manufacturers claim is correct, what is the probability to see a sample mean as high as in a) or higher?
```
