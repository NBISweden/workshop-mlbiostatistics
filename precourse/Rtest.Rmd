...
This is an R Markdown document. Markdown is a simple formatting syn
library(googledrive)
library(googlesheets4)tax for authoring HTML, PDF, and MS Word documents. For more details on using R Markdown see <http://rmarkdown.rstudio.com>.
