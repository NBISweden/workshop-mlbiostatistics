...
```{r}
#| label: fig-plasma-volume
#| fig-cap: Scatter plot showing plasma volume for each weight
...
```{r}
#| label: tbl-gi
#| tbl-cap: Preview of the Galapagos Islands data
...
```{r}
#| label: fig-height-gender
#| fig-cap: Box plot for 10 000 heigth measurments stratifed by gender
#| fig-cap-location: margin
#| collapse: true
#| code-fold: false
...
## Example: Height, weight and gender I
