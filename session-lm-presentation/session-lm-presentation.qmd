...
- We can think of linear models in machine learning context, as they are often both regression and classification prediction tasks. 
- It is often the case that some or many of the variables used in linear models **are not** associated with the response. 
...
**Adjusted R-squared** 
$$R_{adj}^2=1-\frac{RSS}{TSS}\frac{n-1}{n-p-1}$$
